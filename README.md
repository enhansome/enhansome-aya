...
[Aya](https://github.com/aya-rs/aya) ⭐ 4,823 | 🐛 205 | 🌐 Rust | 📅 2026-09-25 is an eBPF library built with a focus on operability
...
* [Aya templates for `cargo-generate`](https://github.com/aya-rs/aya-template) ⭐ 143 | 🐛 6 | 🌐 Rust | 📅 2026-09-22 - An easy way to generate a new Aya project using [`cargo-generate`](https://github.com/cargo-generate/cargo-generate) ⭐ 2,486 | 🐛 30 | 🌐 Rust | 📅 2026-09-24
...
* [luci-app-bandix](https://github.com/timsaya/luci-app-bandix) ⭐ 944 | 🐛 45 | 🌐 JavaScript | 📅 2026-09-24 - A [OpenWrt](https://github.com/openwrt/openwrt) ⭐ 28,518 | 🐛 4,519 | 🌐 C | 📅 2026-09-25 traffic monitoring application
...
* [blixt](https://github.com/kubernetes-sigs/blixt) ⚠️ Archived - A [Kubernetes](https://kubernetes.io) [Gateway API](https://gateway-api.sigs.k8s.io) based Layer 4 Load-Balancer for ingress
  * Aya is used for eBPF code AND userspace (also uses [Kube-RS](https://github.com/kube-rs/kube) ⭐ 3,829 | 🐛 135 | 🌐 Rust | 📅 2026-09-24 for control-plane)
...
The original idea for [awesome](https://github.com/sindresorhus/awesome) ⭐ 510,128 | 🐛 107 | 📅 2026-09-02 comes from
