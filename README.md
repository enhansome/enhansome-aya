...
[Aya](https://github.com/aya-rs/aya) ⭐ 4,769 | 🐛 204 | 🌐 Rust | 📅 2026-08-19 is an eBPF library built with a focus on operability
...
* [Aya templates for `cargo-generate`](https://github.com/aya-rs/aya-template) ⭐ 140 | 🐛 5 | 🌐 Rust | 📅 2026-08-15 - An easy way to generate a new Aya project using [`cargo-generate`](https://github.com/cargo-generate/cargo-generate) ⭐ 2,472 | 🐛 54 | 🌐 Rust | 📅 2026-08-17
...
* [kunai](https://github.com/kunai-project/kunai) ⭐ 1,084 | 🐛 16 | 🌐 Rust | 📅 2026-08-14 - A threat hunting/detection security monitoring tool:
...
* [luci-app-bandix](https://github.com/timsaya/luci-app-bandix) ⭐ 904 | 🐛 48 | 🌐 JavaScript | 📅 2026-08-18 - A [OpenWrt](https://github.com/openwrt/openwrt) ⭐ 28,029 | 🐛 4,327 | 🌐 C | 📅 2026-08-19 traffic monitoring application
...
The original idea for [awesome](https://github.com/sindresorhus/awesome) ⭐ 497,473 | 🐛 102 | 📅 2026-08-18 comes from
[Sindre Sorhus](https://github.com/sindresorhus). The format of this repository is based
on [zoidbergwill's Awesome eBPF list](https://github.com/zoidbergwill/awesome-ebpf) ⭐ 5,143 | 🐛 12 | 📅 2026-08-12.
