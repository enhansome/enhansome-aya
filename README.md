...
[Aya](https://github.com/aya-rs/aya) ⭐ 4,782 | 🐛 206 | 🌐 Rust | 📅 2026-08-24 is an eBPF library built with a focus on operability
...
* [Aya templates for `cargo-generate`](https://github.com/aya-rs/aya-template) ⭐ 140 | 🐛 5 | 🌐 Rust | 📅 2026-08-15 - An easy way to generate a new Aya project using [`cargo-generate`](https://github.com/cargo-generate/cargo-generate) ⭐ 2,476 | 🐛 54 | 🌐 Rust | 📅 2026-08-23
...
* [luci-app-bandix](https://github.com/timsaya/luci-app-bandix) ⭐ 906 | 🐛 48 | 🌐 JavaScript | 📅 2026-08-18 - A [OpenWrt](https://github.com/openwrt/openwrt) ⭐ 28,080 | 🐛 4,373 | 🌐 C | 📅 2026-08-23 traffic monitoring application
...
The original idea for [awesome](https://github.com/sindresorhus/awesome) ⭐ 499,336 | 🐛 106 | 📅 2026-08-21 comes from
