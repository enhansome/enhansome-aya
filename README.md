...
[Aya](https://github.com/aya-rs/aya) ⭐ 4,779 | 🐛 207 | 🌐 Rust | 📅 2026-08-23 is an eBPF library built with a focus on operability
...
* [Aya templates for `cargo-generate`](https://github.com/aya-rs/aya-template) ⭐ 140 | 🐛 5 | 🌐 Rust | 📅 2026-08-15 - An easy way to generate a new Aya project using [`cargo-generate`](https://github.com/cargo-generate/cargo-generate) ⭐ 2,476 | 🐛 54 | 🌐 Rust | 📅 2026-08-17
...
* [luci-app-bandix](https://github.com/timsaya/luci-app-bandix) ⭐ 906 | 🐛 48 | 🌐 JavaScript | 📅 2026-08-18 - A [OpenWrt](https://github.com/openwrt/openwrt) ⭐ 28,069 | 🐛 4,368 | 🌐 C | 📅 2026-08-22 traffic monitoring application
...
* [blixt](https://github.com/kubernetes-sigs/blixt) ⚠️ Archived - A [Kubernetes](https://kubernetes.io) [Gateway API](https://gateway-api.sigs.k8s.io) based Layer 4 Load-Balancer for ingress
  * Aya is used for eBPF code AND userspace (also uses [Kube-RS](https://github.com/kube-rs/kube) ⭐ 3,804 | 🐛 133 | 🌐 Rust | 📅 2026-08-04 for control-plane)
...
* [bombini](https://github.com/anfedotoff/bombini) ⭐ 57 | 🐛 7 | 🌐 Rust | 📅 2026-08-17 - An eBPF-based agent for security monitoring
...
The original idea for [awesome](https://github.com/sindresorhus/awesome) ⭐ 499,021 | 🐛 106 | 📅 2026-08-21 comes from
