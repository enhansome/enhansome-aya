...
[Aya](https://github.com/aya-rs/aya) ⭐ 4,789 | 🐛 209 | 🌐 Rust | 📅 2026-09-01 is an eBPF library built with a focus on operability
...
* [Aya templates for `cargo-generate`](https://github.com/aya-rs/aya-template) ⭐ 140 | 🐛 5 | 🌐 Rust | 📅 2026-08-31 - An easy way to generate a new Aya project using [`cargo-generate`](https://github.com/cargo-generate/cargo-generate) ⭐ 2,485 | 🐛 27 | 🌐 Rust | 📅 2026-08-31
...
* [profile-bee](https://github.com/zz85/profile-bee/) ⭐ 72 | 🐛 22 | 🌐 Rust | 📅 2026-09-01 - CPU profiler with interactive TUI, DWARF unwinding support, and multiple output formats
...
* [luci-app-bandix](https://github.com/timsaya/luci-app-bandix) ⭐ 915 | 🐛 47 | 🌐 JavaScript | 📅 2026-08-18 - A [OpenWrt](https://github.com/openwrt/openwrt) ⭐ 28,168 | 🐛 4,412 | 🌐 C | 📅 2026-09-01 traffic monitoring application
...
* [blixt](https://github.com/kubernetes-sigs/blixt) ⚠️ Archived - A [Kubernetes](https://kubernetes.io) [Gateway API](https://gateway-api.sigs.k8s.io) based Layer 4 Load-Balancer for ingress
  * Aya is used for eBPF code AND userspace (also uses [Kube-RS](https://github.com/kube-rs/kube) ⭐ 3,808 | 🐛 134 | 🌐 Rust | 📅 2026-08-29 for control-plane)
...
* [bombini](https://github.com/anfedotoff/bombini) ⭐ 58 | 🐛 16 | 🌐 Rust | 📅 2026-08-31 - An eBPF-based agent for security monitoring
...
The original idea for [awesome](https://github.com/sindresorhus/awesome) ⭐ 501,818 | 🐛 105 | 📅 2026-08-21 comes from
