...
[Aya](https://github.com/aya-rs/aya) ⭐ 4,785 | 🐛 207 | 🌐 Rust | 📅 2026-08-27 is an eBPF library built with a focus on operability
...
* [Aya templates for `cargo-generate`](https://github.com/aya-rs/aya-template) ⭐ 140 | 🐛 6 | 🌐 Rust | 📅 2026-08-24 - An easy way to generate a new Aya project using [`cargo-generate`](https://github.com/cargo-generate/cargo-generate) ⭐ 2,482 | 🐛 56 | 🌐 Rust | 📅 2026-08-25
...
* [oryx](https://github.com/pythops/oryx) ⭐ 2,569 | 🐛 5 | 🌐 Rust | 📅 2026-07-17 - A TUI (Terminal User Interface) for sniffing network traffic.
* [profile-bee](https://github.com/zz85/profile-bee/) ⭐ 72 | 🐛 23 | 🌐 Rust | 📅 2026-08-26 - CPU profiler with interactive TUI, DWARF unwinding support, and multiple output formats
...
* [luci-app-bandix](https://github.com/timsaya/luci-app-bandix) ⭐ 912 | 🐛 47 | 🌐 JavaScript | 📅 2026-08-18 - A [OpenWrt](https://github.com/openwrt/openwrt) ⭐ 28,118 | 🐛 4,396 | 🌐 C | 📅 2026-08-27 traffic monitoring application
