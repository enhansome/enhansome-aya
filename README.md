...
[Aya](https://github.com/aya-rs/aya) ⭐ 4,786 | 🐛 207 | 🌐 Rust | 📅 2026-08-28 is an eBPF library built with a focus on operability
...
* [Aya templates for `cargo-generate`](https://github.com/aya-rs/aya-template) ⭐ 140 | 🐛 6 | 🌐 Rust | 📅 2026-08-24 - An easy way to generate a new Aya project using [`cargo-generate`](https://github.com/cargo-generate/cargo-generate) ⭐ 2,483 | 🐛 56 | 🌐 Rust | 📅 2026-08-25
...
* [oryx](https://github.com/pythops/oryx) ⭐ 2,570 | 🐛 5 | 🌐 Rust | 📅 2026-07-17 - A TUI (Terminal User Interface) for sniffing network traffic.
* [profile-bee](https://github.com/zz85/profile-bee/) ⭐ 72 | 🐛 22 | 🌐 Rust | 📅 2026-08-28 - CPU profiler with interactive TUI, DWARF unwinding support, and multiple output formats
...
* [luci-app-bandix](https://github.com/timsaya/luci-app-bandix) ⭐ 912 | 🐛 47 | 🌐 JavaScript | 📅 2026-08-18 - A [OpenWrt](https://github.com/openwrt/openwrt) ⭐ 28,130 | 🐛 4,403 | 🌐 C | 📅 2026-08-27 traffic monitoring application
...
The original idea for [awesome](https://github.com/sindresorhus/awesome) ⭐ 500,743 | 🐛 105 | 📅 2026-08-21 comes from
