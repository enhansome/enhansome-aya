...
[Aya](https://github.com/aya-rs/aya) ⭐ 4,822 | 🐛 203 | 🌐 Rust | 📅 2026-09-24 is an eBPF library built with a focus on operability
...
* [Aya templates for `cargo-generate`](https://github.com/aya-rs/aya-template) ⭐ 143 | 🐛 6 | 🌐 Rust | 📅 2026-09-22 - An easy way to generate a new Aya project using [`cargo-generate`](https://github.com/cargo-generate/cargo-generate) ⭐ 2,486 | 🐛 29 | 🌐 Rust | 📅 2026-09-21
...
* [kunai](https://github.com/kunai-project/kunai) ⭐ 1,091 | 🐛 15 | 🌐 Rust | 📅 2026-09-23 - A threat hunting/detection security monitoring tool:
...
* [luci-app-bandix](https://github.com/timsaya/luci-app-bandix) ⭐ 944 | 🐛 45 | 🌐 JavaScript | 📅 2026-09-06 - A [OpenWrt](https://github.com/openwrt/openwrt) ⭐ 28,505 | 🐛 4,530 | 🌐 C | 📅 2026-09-24 traffic monitoring application
  * Built on top of [bandix](https://github.com/timsaya/bandix) ⭐ 36 | 🐛 4 | 🌐 Rust | 📅 2026-09-23 core backend, which uses Aya framework for eBPF program loading and management
...
* [blixt](https://github.com/kubernetes-sigs/blixt) ⚠️ Archived - A [Kubernetes](https://kubernetes.io) [Gateway API](https://gateway-api.sigs.k8s.io) based Layer 4 Load-Balancer for ingress
  * Aya is used for eBPF code AND userspace (also uses [Kube-RS](https://github.com/kube-rs/kube) ⭐ 3,828 | 🐛 135 | 🌐 Rust | 📅 2026-09-24 for control-plane)
...
* [bombini](https://github.com/anfedotoff/bombini) ⭐ 68 | 🐛 10 | 🌐 Rust | 📅 2026-09-22 - An eBPF-based agent for security monitoring
...
The original idea for [awesome](https://github.com/sindresorhus/awesome) ⭐ 509,595 | 🐛 106 | 📅 2026-09-02 comes from
[Sindre Sorhus](https://github.com/sindresorhus). The format of this repository is based
on [zoidbergwill's Awesome eBPF list](https://github.com/zoidbergwill/awesome-ebpf) ⭐ 5,173 | 🐛 16 | 📅 2026-09-14.
