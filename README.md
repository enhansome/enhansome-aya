...
[Aya](https://github.com/aya-rs/aya) ⭐ 4,769 | 🐛 205 | 🌐 Rust | 📅 2026-08-17 is an eBPF library built with a focus on operability
...
* [Aya templates for `cargo-generate`](https://github.com/aya-rs/aya-template) ⭐ 140 | 🐛 5 | 🌐 Rust | 📅 2026-08-15 - An easy way to generate a new Aya project using [`cargo-generate`](https://github.com/cargo-generate/cargo-generate) ⭐ 2,472 | 🐛 53 | 🌐 Rust | 📅 2026-08-17
...
* [oryx](https://github.com/pythops/oryx) ⭐ 2,555 | 🐛 5 | 🌐 Rust | 📅 2026-07-17 - A TUI (Terminal User Interface) for sniffing network traffic.
...
* [luci-app-bandix](https://github.com/timsaya/luci-app-bandix) ⭐ 903 | 🐛 48 | 🌐 JavaScript | 📅 2026-08-18 - A [OpenWrt](https://github.com/openwrt/openwrt) ⭐ 28,019 | 🐛 4,326 | 🌐 C | 📅 2026-08-18 traffic monitoring application
...
* [blixt](https://github.com/kubernetes-sigs/blixt) ⚠️ Archived - A [Kubernetes](https://kubernetes.io) [Gateway API](https://gateway-api.sigs.k8s.io) based Layer 4 Load-Balancer for ingress
  * Aya is used for eBPF code AND userspace (also uses [Kube-RS](https://github.com/kube-rs/kube) ⭐ 3,802 | 🐛 133 | 🌐 Rust | 📅 2026-08-04 for control-plane)
...
* [bombini](https://github.com/anfedotoff/bombini) ⭐ 54 | 🐛 7 | 🌐 Rust | 📅 2026-08-17 - An eBPF-based agent for security monitoring
...
The original idea for [awesome](https://github.com/sindresorhus/awesome) ⭐ 497,042 | 🐛 102 | 📅 2026-06-30 comes from
[Sindre Sorhus](https://github.com/sindresorhus). The format of this repository is based
on [zoidbergwill's Awesome eBPF list](https://github.com/zoidbergwill/awesome-ebpf) ⭐ 5,141 | 🐛 12 | 📅 2026-08-12.
