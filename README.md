...
[Aya](https://github.com/aya-rs/aya) ⭐ 4,783 | 🐛 207 | 🌐 Rust | 📅 2026-08-26 is an eBPF library built with a focus on operability
...
* [Aya templates for `cargo-generate`](https://github.com/aya-rs/aya-template) ⭐ 140 | 🐛 6 | 🌐 Rust | 📅 2026-08-24 - An easy way to generate a new Aya project using [`cargo-generate`](https://github.com/cargo-generate/cargo-generate) ⭐ 2,478 | 🐛 56 | 🌐 Rust | 📅 2026-08-25
...
* [oryx](https://github.com/pythops/oryx) ⭐ 2,563 | 🐛 5 | 🌐 Rust | 📅 2026-07-17 - A TUI (Terminal User Interface) for sniffing network traffic.
...
* [luci-app-bandix](https://github.com/timsaya/luci-app-bandix) ⭐ 909 | 🐛 48 | 🌐 JavaScript | 📅 2026-08-18 - A [OpenWrt](https://github.com/openwrt/openwrt) ⭐ 28,104 | 🐛 4,384 | 🌐 C | 📅 2026-08-25 traffic monitoring application
...
* [blixt](https://github.com/kubernetes-sigs/blixt) ⚠️ Archived - A [Kubernetes](https://kubernetes.io) [Gateway API](https://gateway-api.sigs.k8s.io) based Layer 4 Load-Balancer for ingress
  * Aya is used for eBPF code AND userspace (also uses [Kube-RS](https://github.com/kube-rs/kube) ⭐ 3,805 | 🐛 134 | 🌐 Rust | 📅 2026-08-04 for control-plane)
...
The original idea for [awesome](https://github.com/sindresorhus/awesome) ⭐ 499,966 | 🐛 106 | 📅 2026-08-21 comes from
