...
[Aya](https://github.com/aya-rs/aya) ⭐ 4,790 | 🐛 210 | 🌐 Rust | 📅 2026-09-03 is an eBPF library built with a focus on operability
...
* [oryx](https://github.com/pythops/oryx) ⭐ 2,573 | 🐛 5 | 🌐 Rust | 📅 2026-09-01 - A TUI (Terminal User Interface) for sniffing network traffic.
...
* [luci-app-bandix](https://github.com/timsaya/luci-app-bandix) ⭐ 920 | 🐛 47 | 🌐 JavaScript | 📅 2026-08-18 - A [OpenWrt](https://github.com/openwrt/openwrt) ⭐ 28,221 | 🐛 4,429 | 🌐 C | 📅 2026-09-02 traffic monitoring application
...
* [bombini](https://github.com/anfedotoff/bombini) ⭐ 59 | 🐛 14 | 🌐 Rust | 📅 2026-09-01 - An eBPF-based agent for security monitoring
...
The original idea for [awesome](https://github.com/sindresorhus/awesome) ⭐ 502,505 | 🐛 105 | 📅 2026-09-02 comes from
[Sindre Sorhus](https://github.com/sindresorhus). The format of this repository is based
on [zoidbergwill's Awesome eBPF list](https://github.com/zoidbergwill/awesome-ebpf) ⭐ 5,155 | 🐛 13 | 📅 2026-08-12.
