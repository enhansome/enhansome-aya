...
[Aya](https://github.com/aya-rs/aya) ⭐ 4,786 | 🐛 207 | 🌐 Rust | 📅 2026-08-29 is an eBPF library built with a focus on operability
...
* [Aya templates for `cargo-generate`](https://github.com/aya-rs/aya-template) ⭐ 140 | 🐛 6 | 🌐 Rust | 📅 2026-08-24 - An easy way to generate a new Aya project using [`cargo-generate`](https://github.com/cargo-generate/cargo-generate) ⭐ 2,484 | 🐛 48 | 🌐 Rust | 📅 2026-08-28
