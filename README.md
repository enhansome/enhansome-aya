...
[Aya](https://github.com/aya-rs/aya) ⭐ 4,778 | 🐛 207 | 🌐 Rust | 📅 2026-08-22 is an eBPF library built with a focus on operability
...
* [The Aya Book](https://github.com/aya-rs/book) ⭐ 145 | 🐛 26 | 🌐 Shell | 📅 2026-08-14 - The official Aya book, currently a work in progress
  * Some code examples are [available here](https://github.com/aya-rs/book/tree/main/examples) ⭐ 145 | 🐛 26 | 🌐 Shell | 📅 2026-08-14
  * Compiled mdbook version is [available here](https://aya-rs.github.io/book/)
* [Aya templates for `cargo-generate`](https://github.com/aya-rs/aya-template) ⭐ 140 | 🐛 5 | 🌐 Rust | 📅 2026-08-15 - An easy way to generate a new Aya project using [`cargo-generate`](https://github.com/cargo-generate/cargo-generate) ⭐ 2,475 | 🐛 54 | 🌐 Rust | 📅 2026-08-17
...
* [oryx](https://github.com/pythops/oryx) ⭐ 2,564 | 🐛 5 | 🌐 Rust | 📅 2026-07-17 - A TUI (Terminal User Interface) for sniffing network traffic.
...
* [kunai](https://github.com/kunai-project/kunai) ⭐ 1,084 | 🐛 17 | 🌐 Rust | 📅 2026-08-21 - A threat hunting/detection security monitoring tool:
...
* [luci-app-bandix](https://github.com/timsaya/luci-app-bandix) ⭐ 906 | 🐛 48 | 🌐 JavaScript | 📅 2026-08-18 - A [OpenWrt](https://github.com/openwrt/openwrt) ⭐ 28,061 | 🐛 4,343 | 🌐 C | 📅 2026-08-21 traffic monitoring application
...
* [blixt](https://github.com/kubernetes-sigs/blixt) ⚠️ Archived - A [Kubernetes](https://kubernetes.io) [Gateway API](https://gateway-api.sigs.k8s.io) based Layer 4 Load-Balancer for ingress
  * Aya is used for eBPF code AND userspace (also uses [Kube-RS](https://github.com/kube-rs/kube) ⭐ 3,803 | 🐛 133 | 🌐 Rust | 📅 2026-08-04 for control-plane)
...
* [bombini](https://github.com/anfedotoff/bombini) ⭐ 56 | 🐛 7 | 🌐 Rust | 📅 2026-08-17 - An eBPF-based agent for security monitoring
...
The original idea for [awesome](https://github.com/sindresorhus/awesome) ⭐ 498,687 | 🐛 105 | 📅 2026-08-21 comes from
[Sindre Sorhus](https://github.com/sindresorhus). The format of this repository is based
on [zoidbergwill's Awesome eBPF list](https://github.com/zoidbergwill/awesome-ebpf) ⭐ 5,150 | 🐛 13 | 📅 2026-08-12.
