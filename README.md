...
[Aya](https://github.com/aya-rs/aya) ⭐ 4,754 | 🐛 204 | 🌐 Rust | 📅 2026-08-13 is an eBPF library built with a focus on operability
...
* [The Aya Book](https://github.com/aya-rs/book) ⭐ 144 | 🐛 26 | 🌐 Shell | 📅 2026-08-10 - The official Aya book, currently a work in progress
  * Some code examples are [available here](https://github.com/aya-rs/book/tree/main/examples) ⭐ 144 | 🐛 26 | 🌐 Shell | 📅 2026-08-10
  * Compiled mdbook version is [available here](https://aya-rs.github.io/book/)
* [Aya templates for `cargo-generate`](https://github.com/aya-rs/aya-template) ⭐ 140 | 🐛 6 | 🌐 Rust | 📅 2026-08-10 - An easy way to generate a new Aya project using [`cargo-generate`](https://github.com/cargo-generate/cargo-generate) ⭐ 2,471 | 🐛 51 | 🌐 Rust | 📅 2026-08-10
...
* [oryx](https://github.com/pythops/oryx) ⭐ 2,553 | 🐛 5 | 🌐 Rust | 📅 2026-07-17 - A TUI (Terminal User Interface) for sniffing network traffic.
...
* [kunai](https://github.com/kunai-project/kunai) ⭐ 1,083 | 🐛 16 | 🌐 Rust | 📅 2026-07-10 - A threat hunting/detection security monitoring tool:
...
* [luci-app-bandix](https://github.com/timsaya/luci-app-bandix) ⭐ 900 | 🐛 47 | 🌐 JavaScript | 📅 2026-08-12 - A [OpenWrt](https://github.com/openwrt/openwrt) ⭐ 27,970 | 🐛 4,318 | 🌐 C | 📅 2026-08-13 traffic monitoring application
...
* [bombini](https://github.com/anfedotoff/bombini) ⭐ 54 | 🐛 5 | 🌐 Rust | 📅 2026-08-12 - An eBPF-based agent for security monitoring
...
The original idea for [awesome](https://github.com/sindresorhus/awesome) ⭐ 495,063 | 🐛 100 | 📅 2026-06-30 comes from
[Sindre Sorhus](https://github.com/sindresorhus). The format of this repository is based
on [zoidbergwill's Awesome eBPF list](https://github.com/zoidbergwill/awesome-ebpf) ⭐ 5,133 | 🐛 12 | 📅 2026-08-12.
