...
[Aya](https://github.com/aya-rs/aya) ⭐ 4,799 | 🐛 209 | 🌐 Rust | 📅 2026-09-09 is an eBPF library built with a focus on operability
...
* [Aya templates for `cargo-generate`](https://github.com/aya-rs/aya-template) ⭐ 140 | 🐛 6 | 🌐 Rust | 📅 2026-09-07 - An easy way to generate a new Aya project using [`cargo-generate`](https://github.com/cargo-generate/cargo-generate) ⭐ 2,485 | 🐛 29 | 🌐 Rust | 📅 2026-09-07
...
* [oryx](https://github.com/pythops/oryx) ⭐ 2,575 | 🐛 5 | 🌐 Rust | 📅 2026-09-01 - A TUI (Terminal User Interface) for sniffing network traffic.
* [profile-bee](https://github.com/zz85/profile-bee/) ⭐ 72 | 🐛 21 | 🌐 Rust | 📅 2026-09-08 - CPU profiler with interactive TUI, DWARF unwinding support, and multiple output formats
...
* [luci-app-bandix](https://github.com/timsaya/luci-app-bandix) ⭐ 932 | 🐛 45 | 🌐 JavaScript | 📅 2026-09-06 - A [OpenWrt](https://github.com/openwrt/openwrt) ⭐ 28,336 | 🐛 4,437 | 🌐 C | 📅 2026-09-08 traffic monitoring application
...
The original idea for [awesome](https://github.com/sindresorhus/awesome) ⭐ 504,365 | 🐛 106 | 📅 2026-09-02 comes from
