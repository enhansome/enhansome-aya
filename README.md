...
[Aya](https://github.com/aya-rs/aya) ⭐ 4,819 | 🐛 203 | 🌐 Rust | 📅 2026-09-21 is an eBPF library built with a focus on operability
...
* [kunai](https://github.com/kunai-project/kunai) ⭐ 1,090 | 🐛 17 | 🌐 Rust | 📅 2026-09-18 - A threat hunting/detection security monitoring tool:
...
* [luci-app-bandix](https://github.com/timsaya/luci-app-bandix) ⭐ 940 | 🐛 44 | 🌐 JavaScript | 📅 2026-09-06 - A [OpenWrt](https://github.com/openwrt/openwrt) ⭐ 28,473 | 🐛 4,490 | 🌐 C | 📅 2026-09-20 traffic monitoring application
...
* [blixt](https://github.com/kubernetes-sigs/blixt) ⚠️ Archived - A [Kubernetes](https://kubernetes.io) [Gateway API](https://gateway-api.sigs.k8s.io) based Layer 4 Load-Balancer for ingress
  * Aya is used for eBPF code AND userspace (also uses [Kube-RS](https://github.com/kube-rs/kube) ⭐ 3,825 | 🐛 135 | 🌐 Rust | 📅 2026-09-20 for control-plane)
...
* [bombini](https://github.com/anfedotoff/bombini) ⭐ 67 | 🐛 11 | 🌐 Rust | 📅 2026-09-19 - An eBPF-based agent for security monitoring
...
The original idea for [awesome](https://github.com/sindresorhus/awesome) ⭐ 508,355 | 🐛 106 | 📅 2026-09-02 comes from
[Sindre Sorhus](https://github.com/sindresorhus). The format of this repository is based
on [zoidbergwill's Awesome eBPF list](https://github.com/zoidbergwill/awesome-ebpf) ⭐ 5,170 | 🐛 15 | 📅 2026-09-14.
