...
[Aya](https://github.com/aya-rs/aya) ⭐ 4,768 | 🐛 206 | 🌐 Rust | 📅 2026-08-17 is an eBPF library built with a focus on operability
...
* [Aya templates for `cargo-generate`](https://github.com/aya-rs/aya-template) ⭐ 140 | 🐛 5 | 🌐 Rust | 📅 2026-08-15 - An easy way to generate a new Aya project using [`cargo-generate`](https://github.com/cargo-generate/cargo-generate) ⭐ 2,471 | 🐛 51 | 🌐 Rust | 📅 2026-08-10
...
* [oryx](https://github.com/pythops/oryx) ⭐ 2,556 | 🐛 5 | 🌐 Rust | 📅 2026-07-17 - A TUI (Terminal User Interface) for sniffing network traffic.
...
* [luci-app-bandix](https://github.com/timsaya/luci-app-bandix) ⭐ 903 | 🐛 50 | 🌐 JavaScript | 📅 2026-08-12 - A [OpenWrt](https://github.com/openwrt/openwrt) ⭐ 28,006 | 🐛 4,328 | 🌐 C | 📅 2026-08-16 traffic monitoring application
...
The original idea for [awesome](https://github.com/sindresorhus/awesome) ⭐ 496,637 | 🐛 100 | 📅 2026-06-30 comes from
[Sindre Sorhus](https://github.com/sindresorhus). The format of this repository is based
on [zoidbergwill's Awesome eBPF list](https://github.com/zoidbergwill/awesome-ebpf) ⭐ 5,139 | 🐛 12 | 📅 2026-08-12.
